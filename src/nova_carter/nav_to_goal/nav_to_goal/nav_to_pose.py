...
def main():
    ...
    waypoints.append(create_pose(nav, 0.965, 1.568, 90.0))   # 경유지 1
    waypoints.append(create_pose(nav, 0.284, 4.468, 90.0))  # 경유지 2
    waypoints.append(create_pose(nav, -4.278, 4.444 , 90.0))  # 경유지 3 (최종 목적지)
